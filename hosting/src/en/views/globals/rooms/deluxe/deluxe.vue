...
<div class="Dobule-Page">
  ...
  <section class="Single">
    ...
    <div class="kok1">
      ...
      <li>
        Room area about 37 m² to 45 m².
      </li>
      <li>
        Beautiful view inside room with a comfortable working space.
      </li>
    </ui>
    </div>
  </section>
  ...
  <section class="Notes">
    ...
    <div class="kok2">
      <ui>
      <li>
        Inside the resort, there is no way for wheelchairs. But there will be staff to help. in the case of an elderly person
      </li>
      <li>
...
<script lang="ts" src="./deluxe.ts" ></script>
<style scoped lang="scss" src="./deluxe.scss"></style>
